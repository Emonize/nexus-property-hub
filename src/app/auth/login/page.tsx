      ...
      <div className="auth-card fade-in">
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ color: 'var(--nexus-text-secondary)', marginTop: 8, fontSize: 14 }}>
            Sign in to your Nexus Property Hub account
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: 16 }}>
            <label className="nexus-label" htmlFor="login-email">Email</label>
            <input
              id="login-email"
          ...
          <div style={{ marginBottom: 24 }}>
            <label className="nexus-label" htmlFor="login-password">Password</label>
            <input
              id="login-password"
              className="nexus-input"
              type="password"
        ...
        <p style={{ textAlign: 'center', marginTop: 24, fontSize: 14, color: 'var(--nexus-text-secondary)' }}>
          ...
          <Link href="/auth/signup" style={{ color: 'var(--nexus-primary-light)', textDecoration: 'none', fontWeight: 600 }}>
            Sign up
          </Link>
        </p>
      </div>
